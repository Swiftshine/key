...
#if 0
#include <revolution/GX/GXEnum.h> // GXTexFmt
#endif
...
namespace nw4hbm { namespace ut
{
	...
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x4a2c44
	enum FontEncoding
	{
		FONT_ENCODING_UTF8,
		FONT_ENCODING_UTF16,
	...
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x49b34a
	struct CharWidths
	{
	...
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x49b4b8
	struct FontWidth
	{
	...
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x4a15c3
	struct Glyph
	{
	...
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x49b39a
	...
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x49b531
	struct FontCodeMap
	{
	...
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x49b254
	...
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x480fde
	class Font
	{
	// enums
	public:
		// [SGLEA4]/GormitiDebug.elf:.debug_info::0x4a413b
		enum Type
		{
			TYPE_NULL,
