...
{
	// [SGLEA4]/GormitiDebug.elf:.debug_info::0x4777f2
	...
	public:
		...
		{
			const charT * const charStrm =
				static_cast<const charT * const>(mCharStrm);
		...
		{
			// ...sure
			const charT *&charStrm =
				*reinterpret_cast<const charT **>(&mCharStrm);
