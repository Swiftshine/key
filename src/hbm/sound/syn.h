#ifndef RVL_SDK_HBM_SOUND_SYN_H
#define RVL_SDK_HBM_SOUND_SYN_H
...
// [SGLEA4]/GormitiDebug.elf:.debug_info::0x47dcf4
...
// [SGLEA4]/GormitiDebug.elf:.debug_info::0x47ddae
...
// [SGLEA4]/GormitiDebug.elf:.debug_info::0x47df5b
...
// [SGLEA4]/GormitiDebug.elf:.debug_info::0x47dfce
...
// [SGLEA4]/GormitiDebug.elf:.debug_info::0x47db0b
struct HBMSYNSYNTH
{
	...
	WTINST		*inst[NUM_MIDI_CHANNELS];					// size 0x0040, offset 0x0028
	s32			masterVolume;								// size 0x0004, offset 0x0068
	s32			volAttn[NUM_MIDI_CHANNELS];					// size 0x0040, offset 0x006c
	s32			auxAAttn[NUM_MIDI_CHANNELS];				// size 0x0040, offset 0x00ac
	u8			pan[NUM_MIDI_CHANNELS];						// size 0x0010, offset 0x00ec
	...
	HBMSYNVOICE	*voice[NUM_MIDI_CHANNELS][NUM_MIDI_NOTES];	// size 0x2000, offset 0x0408
}; // size 0x2408
