...
public:
    ...
    FB2Tex(gfl::Scene* pScene, u16 sourceW, u16 sourceH, u16 destW, u16 destH, bool arg6, s32 translucency, GXTexFmt texFormat, bool refreshTexture, const char* pName);
