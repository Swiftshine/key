...
include_dirs = [
    ...
    os.path.join(root_dir, "src/fluff/"),
    os.path.join(root_dir, "src/gfl/"),
    os.path.join(root_dir, "src/PowerPC_EABI_Support/"),
    os.path.join(root_dir, "src/PowerPC_EABI_Support/MSL/"),
    os.path.join(root_dir, "src/PowerPC_EABI_Support/MSL/MSL_C/"),
    os.path.join(root_dir, "src/PowerPC_EABI_Support/MSL/MSL_C/MSL_Common/"),
    os.path.join(root_dir, "src/PowerPC_EABI_Support/MSL/MSL_C++/"),
    os.path.join(root_dir, "src/nw4r/"),
    os.path.join(root_dir, "src/nw4r/math/"),
    os.path.join(root_dir, "src/nw4r/g3d/"),
    os.path.join(root_dir, "src/nw4r/ut/"),
    os.path.join(root_dir, "src/revolution/"),
